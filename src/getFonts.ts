...
export function getFonts() {
  if (!fonts) {
    ...
    fonts['super'] = buildFont(phonetic, phonetic, [0x2070, 0x00b9, 0x00b2, 0x00b3, 0x2074,0x2075, 0x2076, 0x2077, 0x2078, 0x2079], [], 'super', 'Uses Unicode Category "Phonetic Extensions" for letters and "SuperScripts and Subscripts" for digits');
    ...
    // fonts['square2'] = buildFont(0x1f1e6, 0x1f1e6  , 0, [...digits], 'square2', '')
    ...
    const cherokee = [0x13aa, 0x13f4, 0x13df, 0x13a0, 0x13ac, 0x13b0, 0x13b6/*g*/, 0x13bb, 0x13d0, 0x13ab, 0x13e6 /*k*/, 0x13de, 0x13b7, 0, 0x13a4, 0x13e2, 0x13eb/* Q*/, 0x13a1, 0x13da, 0x13a2, 0x13cc, 0x13d9, 0x13d4, 0/*x*/, 0x13bd, 0x13c3]
    fonts['cherokee'] = buildFont(cherokee, cherokee, [0x13be,0x13d0, 0, 0, 0x13ce, 0, 0x13ee, 0, 0, 0x13ed], ['n', 'N', 'x', 'X', '2', '3', '5', '7', '8'], 'cherokee', 'From Unicode category "cherokee"');


    fonts['romanNumerals'] = buildFont(0, 0, 0x2160, [...lower, ...upper], 'romanNumerals', 'From Unicode category "CJK Compatibility Forms"');
    fonts['romanNumeralsSmall'] = buildFont(0, 0, 0x2173, [...lower, ...upper], 'romanNumeralsSmall', 'From Unicode category "CJK Compatibility Forms"');
